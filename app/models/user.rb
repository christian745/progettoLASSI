class User < ApplicationRecord
  ...
  has_many :schedules, dependent: :delete_all   #prima avevo creato le schedules, poi ho creato gli users con device, poi ho aggiunto alle schedules il riferimento allo user_id.
